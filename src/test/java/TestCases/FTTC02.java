...
public class FTTC02 extends TestBase {
    ...
    @Test(dataProvider = "getData", description = "User can cancel all ticket")
    public void MyTicket(Object[] data) throws InterruptedException {
        ...
        String actualErrorMessage = myTicketPage.getErrorMessage().getText();
        Assert.assertEquals(expectedErrorMessage, actualErrorMessage);

        String expectedInfoMessage = "You currently book 0 ticket, you can book 10 more.";
        String actualInfoMessage = myTicketPage.getInfoMessage().getText();
